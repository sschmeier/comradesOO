...
comradesClusteredDataSet <- function(cds,
    ...
    #subset hybLists2
    longDistHyb = subsetHybList2(hybFiles(cds)[[ "noHost" ]],
    ...
    clusters[["original"]] = combinedPlotting
    ...
    clusterTables[["original"]] =clusterPositionsList
    matrixList[["originalClusters"]] = matList
